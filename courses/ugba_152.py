...
class UGBA_152(BaseCourse):
    def __init__(self):
        super().__init__("https://classes.berkeley.edu/content/2025-spring-UGBA-152-001-LEC-001")
    ...
    def extract_data(self, data_json):
        try:
            ...
            message = f"{waitlisted} out of {max_waitlist} waitlist spots are taken."
